...
const scrollActive = () => { setActive(window.scrollY > 20);};
  ...
  return (
    <div className={`${
      active ? "shadow-sm bg-[#e4dcd4] sm:border-b-4 border-[#ad4141]" : ""
    } fixed w-full top-0 left-0 z-20 bg-[#e4dcd4]`}>
      <div>
        <div className={`${
      active ? "py-2 transition-all duration-300 " : "py-4"
         ...
         <div className='flex items-center gap-4'>
          ...
          <div className='text-4xl text-[#ad4141] uppercase tracking-wide font-bold'>
            Skillex
            </div>
         </div>
