...
const CTA2 = () => {
  return (
    ...
    <div className='max-w-[1240px] mx-auto grid lg:grid-cols-3  grid-center px-16 py-16  rounded-xl '>
        <div className='lg:col-span-1  bg-red-50 rounded-xl p-4 h-fit shadow-md'>
