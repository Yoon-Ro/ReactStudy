...
const CTA = () => {
  return (
    <div className='w-full text-black mt-[-80px]'>
    <div className='max-w-[50%] mx-auto  px-16 py-16  rounded-xl'>
        ...
        <div className='my-4 max-w-[50%] mx-auto'>
            ...
            <input className='p-2 flex w-full rounded-md text-black bg-slate-300' type='email' placeholder='Enter Email'/>
